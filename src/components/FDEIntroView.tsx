        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              完成公安实名认证、发布经 Hermes 校验的可运行智能体，并通过运营审核后，即可成为平台认证 AI 专家，进入专家库接收咨询与定制交付商机。
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200/80 space-y-3">
            <div className="flex items-center gap-2 text-xs font-bold text-slate-500 uppercase tracking-wider">
              <span>传统开发者 / Demo 创作者</span>
            </div>
            <h3 className="text-base font-bold text-slate-800">停留在功能原型与公网玩具</h3>
            <ul className="space-y-2 text-xs text-slate-600 leading-relaxed">
              <li className="flex items-start gap-2">
                <span className="text-slate-400 font-bold">✕</span>
                <span>仅依赖通用 Prompt 调优，无法处理复杂的垂直业务流与分支判定。</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-400 font-bold">✕</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-slate-400 font-bold">✕</span>
                <span>缺乏工程隔离沙箱保障，企业对数据安全和运行不可控心存疑虑。</span>
              </li>
            </ul>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-gradient-to-br from-amber-50/70 via-blue-50/40 to-indigo-50/60 border border-amber-200/90 space-y-3 shadow-xs">
            ...
            <ul className="space-y-2 text-xs text-slate-700 leading-relaxed">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>可运行作品门槛：</strong>至少发布经 Hermes 沙箱校验的智能体，进入专家库与咨询入口。
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-600 font-bold">✓</span>
                <span>
                  <strong>Hermes 沙箱工程安全：</strong>代码、敏感凭证与数据隔离，支持合规审查与私有化部署。
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-600 font-bold">✓</span>
                <span>
                  <strong>商业交付闭环：</strong>接收咨询线索、发起定制方案、完成交付订单全流程经营。
                </span>
              </li>
            </ul>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-2xs space-y-3">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              发布通用智能体与客户专属实例，基于真实运行数据积累口碑与线索。
            </p>
          </div>
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-2xs space-y-3">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              跟进基于标准智能体的二次改造需求，通过消息提醒与客户闭环协作。
            </p>
          </div>
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-2xs space-y-3">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              公安人脸实名 + Hermes 沙箱校验，为企业客户提供可信交付主体。
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-2 max-w-xl">
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold text-amber-400 bg-amber-400/10 px-2.5 py-0.5 rounded-full border border-amber-400/20">
              {!isExpert ? '申请 AI 专家认证' : '您已是认证 AI 专家'}
            </span>
          </div>
          <h3 className="text-lg sm:text-xl font-extrabold text-white">
            {!isExpert ? '开启您的 AI 专家认证之旅' : '继续经营您的专家主页与作品'}
          </h3>
          <p className="text-xs text-slate-300 leading-relaxed">
            {!isExpert
              ? '完成实名认证并发布首个 Hermes 可运行智能体，通过运营审核后即可进入专家库。'
