...
export const PersonalCenterView: React.FC<PersonalCenterViewProps> = ({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      {activeTab === 'services' && (
        <section className="pt-6"><div className="flex items-center justify-between"><div><h2 className="text-lg font-extrabold text-slate-950">我的定制</h2><p className="mt-1 text-sm text-slate-500">集中查看确认方案后的支付、交付和验收进度。新咨询请到消息中心处理。</p></div><button className="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-bold text-slate-700"><Search size={16} /> 查看全部</button></div>
